...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 1.95, 1.90, 1.52, 0.82, .572, .46, .37, .32, .1],
  "normal":             [2.00, 2.00, 1.95, 1.65, 1.08, .68,  .59, .48, .38, .2],
  "sport":              [2.00, 2.00, 2.00, 1.90, 1.25, .88,  .70, .60, .48, .3],
}
MAX_ACCEL_BREAKPOINTS = [0.,   1.,   6.,   8.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.0005,  -.0005,  -0.06, -0.06, -0.55, -0.55],
  "normal":             [-.0006,  -.0006,  -0.07, -0.07, -0.60, -0.60],
  "sport":              [-.0007,  -.0007,  -0.08, -0.08, -0.65, -0.65],
