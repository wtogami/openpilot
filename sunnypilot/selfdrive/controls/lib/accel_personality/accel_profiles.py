...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 1.95, 1.90, 1.52, 0.85, .58,  .47, .38, .32, .1],
  "normal":             [2.00, 2.00, 1.95, 1.70, 1.10, .72,  .61, .50, .38, .2],
  "sport":              [2.00, 2.00, 2.00, 1.90, 1.30, 1.00, .72, .60, .48, .3],
}
MAX_ACCEL_BREAKPOINTS = [0.,   1.,   6.,   8.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-0.001, -0.001, -0.01, -0.1,  -0.4,  -1.0],
  "normal":             [-0.002, -0.002, -0.02, -0.2,  -1.2,  -1.2],
  "sport":              [-0.003, -0.003, -0.03, -0.3,  -1.2,  -1.2],
  "stock":              [-1.2,   -1.2,   -1.2,  -1.2,  -1.2,  -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,     3.,     8.,    13.,   14.,    40.]
