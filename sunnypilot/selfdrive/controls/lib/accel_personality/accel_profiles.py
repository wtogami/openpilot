...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 1.95, 1.90, 1.53, 0.83, .575, .46, .37, .32, .1],
  "normal":             [2.00, 2.00, 1.95, 1.70, 1.10, .70,  .59, .48, .38, .2],
  "sport":              [2.00, 2.00, 2.00, 1.90, 1.30, 1.00, .72, .60, .48, .3],
}
MAX_ACCEL_BREAKPOINTS = [0.,   1.,   6.,   8.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-0.002,  -0.002,  -0.01, -0.06, -0.4,  -0.4],
  "normal":             [-0.002,  -0.002,  -0.01, -0.07, -0.4,  -0.4],
  "sport":              [-0.002,  -0.002,  -0.01, -0.08, -0.5,  -0.5],
  "stock":              [-1.2,    -1.2,    -1.2,  -1.2,  -1.2,  -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,      3.,      8.,    14.,   18.,    40.]
